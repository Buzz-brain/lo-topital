    ...
    <div className="pt-16">
        ...
        <div className="container relative py-24">
          ...
          >
            ...
            <p className="text-lg text-gray-100 mb-4 max-w-2xl">
              We'd love to hear from you. Reach out to discuss your project or get answers to your questions.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <motion.div
              ...
              variants={fadeIn}
            >
              <span className="text-sm font-medium text-primary-600 mb-2 block">CONTACT INFORMATION</span>
              <h2 className="text-3xl font-bold mb-6">Get in Touch</h2>
              <p className="text-gray-600 mb-8">
                Have a project in mind or want to learn more about how we can help your business? Fill out the form, and we'll get back to you promptly.
              </p>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="p-2 bg-gray-100 rounded-full text-gray-600 hover:bg-primary-100 hover:text-primary-600 transition-colors">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container">
          ...
          >
            <span className="text-sm font-medium text-primary-600 mb-2 block">OUR LOCATION</span>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Find Us Here</h2>
